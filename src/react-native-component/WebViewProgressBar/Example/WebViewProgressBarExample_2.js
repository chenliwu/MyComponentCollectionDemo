...
export default class WebViewProgressBarExample extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            webViewLoadingProgress: 0,//WebView加载条进度
        };
    }
    ...
    showWebViewLoadingBar = () => {
        ...
        this.progressBarTimer = setInterval(() => {
            let webViewLoadingProgress = this.state.webViewLoadingProgress;
            webViewLoadingProgress += Math.random() / 3;        //Math.random()产生0-1的随机数，包括0,不包括1
            if (webViewLoadingProgress >= 0.9 && webViewLoadingProgress < 1) {
                webViewLoadingProgress = 0.9;
                this.progressBarTimer && clearInterval(this.progressBarTimer);
            }
            if (this.state.webViewIsLoading && webViewLoadingProgress < 1) {
                this.setState({webViewLoadingProgress});
            }
