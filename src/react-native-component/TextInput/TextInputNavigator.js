...
import TextInputExample from './Example/TextInputExample';


class TextInputNavigatorPage extends React.Component {

    static navigationOptions = {
        headerTitle: 'TextInput组件练习',
    };
...
const TextInputNavigator = createStackNavigator(
    {
        TextInputNavigatorPage: {
            screen: TextInputNavigatorPage
        },
    ...
    {
        initialRouteName: 'TextInputNavigatorPage',
        //headerMode: 'center'
    }
);
